...
echo "$CMD $PRG -i $DATA/${TISSUE}_BIO.csv $DATA/${TISSUE}_EmbN2V_128.csv -l $TARGET/${LABELFILE1} -A \"$ALIASES\" -S -X $EXCLABELS -j -1 -P -B  -o $LOGDIR/log_batch_cmp_${METHOD1}_${METHOD2}_${METHOD3}_${METHOD4}_${TISSUE}_${PROB}.txt -s $SCOREDIR/score_cmp_${METHOD1}_${TISSUE}_${PROB}_bion2v.csv" | bash
echo "$CMD $PRG -i $DATA/${TISSUE}_BIO.csv $DATA/${TISSUE}_EmbN2V_128.csv -l $TARGET/${LABELFILE2} -A \"$ALIASES\" -S -X $EXCLABELS -j -1 -P -B  -o $LOGDIR/log_batch_cmp_${METHOD1}_${METHOD2}_${METHOD3}_${METHOD4}_${TISSUE}_${PROB}.txt -s $SCOREDIR/score_cmp_${METHOD2}_${TISSUE}_${PROB}_bion2v.csv" | bash
echo "$CMD $PRG -i $DATA/${TISSUE}_BIO.csv $DATA/${TISSUE}_EmbN2V_128.csv -l $TARGET/${LABELFILE3} -A \"$ALIASES\" -S -X $EXCLABELS -j -1 -P -B  -o $LOGDIR/log_batch_cmp_${METHOD1}_${METHOD2}_${METHOD3}_${METHOD4}_${TISSUE}_${PROB}.txt -s $SCOREDIR/score_cmp_${METHOD3}_${TISSUE}_${PROB}_bion2v.csv" | bash
echo "$CMD $PRG -i $DATA/${TISSUE}_BIO.csv $DATA/${TISSUE}_EmbN2V_128.csv -l $TARGET/${LABELFILE4} -A \"$ALIASES\" -S -X $EXCLABELS -j -1 -P -B  -o $LOGDIR/log_batch_cmp_${METHOD1}_${METHOD2}_${METHOD3}_${METHOD4}_${TISSUE}_${PROB}.txt -s $SCOREDIR/score_cmp_${METHOD4}_${TISSUE}_${PROB}_bion2v.csv" | bash
