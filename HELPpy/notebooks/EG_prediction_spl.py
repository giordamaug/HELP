...
if args.balanced:
   clf = VotingSplitClassifier(n_voters=args.voters, n_jobs=args.jobs, random_state=args.seed, class_weight='balanced')
else:
   clf = VotingSplitClassifier(n_voters=args.voters, n_jobs=args.jobs, random_state=args.seed)
