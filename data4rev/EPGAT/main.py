...
parser.add_argument('-p', "--ppifile", dest='ppifile', metavar='<ppifile>', type=str, default=None, help='PPI file filename', required=False)
...
def main(name, label_path, ppi_path=None,
    ...
    if train_mode:
        ...
        if verbose: 
            print(f'\nTraining the model with params {gat_params}')
