...
class ProcessDataset(object):
    ...
    def partitionDataset(self):
        ...
        if self.embedF == 1:
            ...
            print(f' Using input file embedFeature')
        elif self.embedF == 0:
            fn1 = os.path.join(self.data_dir, 'ess_seqFeature.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_seqFeature.pickle')
            print(f' Using input file seqFeature')
        elif self.embedF == 2:
            fn1 = os.path.join(self.data_dir, 'ess_seqFeature_embedF.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_seqFeature_embedF.pickle')
            print(f' Using input file seqFeature_embedF')
        elif self.embedF == 3:
            fn1 = os.path.join(self.data_dir, 'ess_bioFeature.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_bioFeature.pickle')
            print(f' Using input file bioFeature')
        elif self.embedF == 4:
            fn1 = os.path.join(self.data_dir, 'ess_bioFeature_embedF.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_bioFeature_embedF.pickle')
            print(f' Using input file bioFeature_embedF')
        elif self.embedF == 5:
            fn1 = os.path.join(self.data_dir, 'ess_seqbioFeature_embedF.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_seqbioFeature_embedF.pickle')
            print(f' Using input file seqbioFeature_embedF')
        else:
            raise Exception("Wrong file selection!")
